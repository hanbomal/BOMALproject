...
<script type="text/javascript">
  ...
  +" </div></li></ul>";
	...
	for(var i=0;i<chatdata.length;i++){
		  ...
		  var last=testProcess(chatdata[i]);

	        textarea.innerHTML +="<ul class='w3-ul'><li class='w3-large' style='border:none; max-width:80%;'> "+last[0]
	        +"<span class='w3-small'>&nbsp;"+last[1]+"</span>"
	        +" <div class='w3-panel w3-round-large w3-padding' style='margin:0; max-width:80%;background: rgba(0, 150, 136, 0.75);'>"
	        +" <span class='w3-medium'><font color='white'>"+last[2]+"</font></span>"
	      +" </div></li></ul>";
